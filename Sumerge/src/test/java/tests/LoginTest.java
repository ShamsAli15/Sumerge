...
//    @Test(priority = 6)
//    public void emptyUsernameAndPasswordTC() {
//        new LoginPage(driver)
//                .clickOnLoginButton();
//
//        // Verify the error message for empty username (it may prioritize showing username error first)
//        String expectedErrorMessage = "Epic sadface: Username is required";
//        Assert.assertEquals(LoginPage.getErrorMessage(driver), expectedErrorMessage, "Error message for empty credentials did not match!");
//    }
